...
def follow():
	...
	# list = []
	# for followee in my_followees:
	# 	list.append(followee.followee.username)
	# return render_template('log.html', log = list)
...
def click_follow(followee_id):
	...
	return redirect(url_for('follow', followee_id = followee_id))
